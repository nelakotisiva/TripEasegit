...
CREATE TABLE `restaurant_booking` (
  ...
  CONSTRAINT `restaurant_booking_ibfk_2` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurant` (`restaurant_id`)
...
INSERT INTO `restaurant_booking` VALUES (1,2,11,'2025-11-26',5,'Booked'),(2,2,8,'2025-11-26',5,'Booked'),(3,2,18,'2025-11-28',5,'Booked');
...
-- Dump completed on 2025-11-28 10:06:42
