...
<div class="search-box-wrapper">
    ...
    <div class="search-tabs">
        <div class="tab active" id="tab-flights" onclick="showForm('flights')">✈ Flights</div>
...
<div class="dashboard-container">
    ...
    <div class="card" onclick="showForm('flights')"><div class="icon">✈</div><div class="card-title">Book Flights</div></div>
    ...
    <div class="card" onclick="showForm('restaurants')"><div class="icon">🍽</div><div class="card-title">Find Restaurants</div></div>
